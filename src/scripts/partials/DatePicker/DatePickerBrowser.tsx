...
import { getSurroundingMonths, isPast, Datelike, daysInMonth, isToday } from '../../helpers/DateHelpers';
...
export default function DatePickerBrowser({ 
  selectedDate, 
  setSelectedDateDay, 
  setSelectedDateTime,
  timeInputRef,
  ...
  return (
    <div className="DatePickerBrowser">
